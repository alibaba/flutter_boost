...
public class FlutterBoostFragment extends Fragment implements FlutterActivityAndFragmentDelegate.Host {
     ...
     */
    @NonNull
    public static FlutterBoostFragment createDefault() {
        return new FlutterBoostFragment.NewEngineFragmentBuilder().build();
    }

    /**
     * Returns a {@link FlutterBoostFragment.NewEngineFragmentBuilder} to create a {@code FlutterFragment} with a new
     * {@link FlutterEngine} and a desired engine configuration.
     */
    @NonNull
    public static FlutterBoostFragment.NewEngineFragmentBuilder withNewEngine() {
        return new FlutterBoostFragment.NewEngineFragmentBuilder();
    }
    ...
    public static class NewEngineFragmentBuilder {
        ...
        public NewEngineFragmentBuilder() {
            fragmentClass = FlutterBoostFragment.class;
        }
         ...
         */
        public NewEngineFragmentBuilder(@NonNull Class<? extends FlutterBoostFragment> subclass) {
        ...
        /**
         * The initial route that a Flutter app will render in this {@link FlutterBoostFragment}, defaults to
         * "/".
         */
        @NonNull
         ...
         */
        @NonNull
        public FlutterBoostFragment.NewEngineFragmentBuilder transparencyMode(@NonNull TransparencyMode transparencyMode) {
         ...
         */
        @NonNull
        public FlutterBoostFragment.NewEngineFragmentBuilder shouldAttachEngineToActivity(
    ...
    /**
     * Returns a {@link FlutterBoostFragment.CachedEngineFragmentBuilder} to create a {@code FlutterFragment} with a cached
     ...
     */
    @NonNull
    public static FlutterBoostFragment.CachedEngineFragmentBuilder withCachedEngine(@NonNull String engineId) {
        return new FlutterBoostFragment.CachedEngineFragmentBuilder(engineId);
    }
    ...
    public static class CachedEngineFragmentBuilder {
        ...
        public CachedEngineFragmentBuilder(
                @NonNull Class<? extends FlutterBoostFragment> subclass, @NonNull String engineId) {
