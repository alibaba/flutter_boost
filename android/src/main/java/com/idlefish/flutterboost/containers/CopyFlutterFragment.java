 ...
 */
public class CopyFlutterFragment extends Fragment implements FlutterActivityAndFragmentDelegate.Host {
     ...
     */
    @NonNull
    public static CopyFlutterFragment createDefault() {
        return new CopyFlutterFragment.NewEngineFragmentBuilder().build();
    }

    /**
     * Returns a {@link CopyFlutterFragment.NewEngineFragmentBuilder} to create a {@code FlutterFragment} with a new
     * {@link FlutterEngine} and a desired engine configuration.
     */
    @NonNull
    public static CopyFlutterFragment.NewEngineFragmentBuilder withNewEngine() {
        return new CopyFlutterFragment.NewEngineFragmentBuilder();
    }
    ...
    public static class NewEngineFragmentBuilder {
        private final Class<? extends CopyFlutterFragment> fragmentClass;
        ...
        public NewEngineFragmentBuilder() {
            fragmentClass = CopyFlutterFragment.class;
        }
         ...
         */
        public NewEngineFragmentBuilder(@NonNull Class<? extends CopyFlutterFragment> subclass) {
        ...
        /**
         * The initial route that a Flutter app will render in this {@link CopyFlutterFragment}, defaults to
         * "/".
         */
        @NonNull
         ...
         */
        @NonNull
        public CopyFlutterFragment.NewEngineFragmentBuilder transparencyMode(@NonNull TransparencyMode transparencyMode) {
         ...
         */
        @NonNull
        public CopyFlutterFragment.NewEngineFragmentBuilder shouldAttachEngineToActivity(
         ...
         */
        @NonNull
        public <T extends CopyFlutterFragment> T build() {
            try {
    ...
    /**
     * Returns a {@link CopyFlutterFragment.CachedEngineFragmentBuilder} to create a {@code FlutterFragment} with a cached
     ...
     */
    @NonNull
    public static CopyFlutterFragment.CachedEngineFragmentBuilder withCachedEngine(@NonNull String engineId) {
        return new CopyFlutterFragment.CachedEngineFragmentBuilder(engineId);
    }
     ...
     *       { super(MyFlutterFragment.class); } }
     *   <li>Add appropriate property methods for the new properties.
     *   <li>Override {@link CopyFlutterFragment.CachedEngineFragmentBuilder#createArgs()}, call through to the super
    ...
    public static class CachedEngineFragmentBuilder {
        ...
        public CachedEngineFragmentBuilder(@NonNull String engineId) {
            this(CopyFlutterFragment.class, engineId);
        }

        public CachedEngineFragmentBuilder(
                @NonNull Class<? extends CopyFlutterFragment> subclass, @NonNull String engineId) {
         ...
         */
        @NonNull
        public CopyFlutterFragment.CachedEngineFragmentBuilder destroyEngineWithFragment(
         ...
         */
        @NonNull
        public CopyFlutterFragment.CachedEngineFragmentBuilder renderMode(@NonNull RenderMode renderMode) {
            this.renderMode = renderMode;
            return this;
        }
         ...
         */
        @NonNull
        public CopyFlutterFragment.CachedEngineFragmentBuilder transparencyMode(
         ...
         * surrounding {@code Activity}, along with any plugins that are registered with that {@link
         * FlutterEngine}. This allows plugins to access the {@code Activity}, as well as receive {@code
         * Activity}-specific calls, e.g., {@link android.app.Activity}. If {@code
         * shouldAttachEngineToActivity} is false, then this {@code FlutterFragment} will not
         * automatically manage the connection between its {@link FlutterEngine} and the surrounding
         * {@code Activity}. The {@code Activity} will need to be manually connected to this {@code
         * FlutterFragment}'s {@link FlutterEngine} by the app developer. See {@link
         ...
         */
        @NonNull
        public CopyFlutterFragment.CachedEngineFragmentBuilder shouldAttachEngineToActivity(
                boolean shouldAttachEngineToActivity) {
            this.shouldAttachEngineToActivity = shouldAttachEngineToActivity;
            return this;
        }
    ...
    // possible.
    @CopyFlutterFragment.ActivityCallThrough
...
//        delegate.onPause();
     ...
     * Fragment}.
     *
     * <p>See {@link android.app.Activity}
     *
     * <p>
     *
