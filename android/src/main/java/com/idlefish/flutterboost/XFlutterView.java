...
public class XFlutterView extends FrameLayout {
  ...
  public void attachToFlutterEngine(@NonNull FlutterEngine flutterEngine) {
    ...
    this.flutterEngine.getActivityControlSurface().getPlatformViewsController().attach(getContext(),flutterEngine.getRenderer(),flutterEngine.getDartExecutor());
  ...
  public void detachFromFlutterEngine() {
    ...
    flutterEngine.getActivityControlSurface().getPlatformViewsController().detach();
    flutterEngine.getActivityControlSurface().getPlatformViewsController().onFlutterViewDestroyed();
